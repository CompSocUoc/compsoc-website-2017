<?php
	...
	$project_size = (function_exists('get_field')) ? get_field('project_size', get_the_ID()) : ''; $project_size = empty($project_size) ? 'small' : $project_size;
	...
	$date = get_the_date();
	$post_thumb_size = 'thumb_350x350';
	if($project_size == 'horizontal'){
		$post_thumb_size = 'thumb_350x700';
	}elseif($project_size == 'vertical'){
		$post_thumb_size = 'thumb_700x350';
	}elseif($project_size == 'big'){
		$post_thumb_size = 'thumb_700x700';
	}
	...
	if ($project_size == 'small') $post_classes[] = 'width-1';
	elseif ($project_size == 'big' || $project_size == 'vertical') $post_classes[] = 'width-2';
	//
...
<article class="<?php echo esc_attr( $post_classes );?>"><div class="article-inner k2t-element-hover">
